  ...
  return(
    <div className="main">
      <div className="mainDiv">
        ...
        <ul>
          <li>They are triggered with state and prop updates, as well as after inital render to the DOM.</li>
          <li>Effects are used to trigger certain actions based upon changhes to the component.</li>
