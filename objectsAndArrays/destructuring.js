...
* ************
  ...
  great for pullinginfo out of an array/object and assigning that data to it's own variable
*/
...
* ************
  ...
  - Rest syntax looks exactly like spread syntax
    ...
    - Rest collects multiple elements and condesnes into a single element
    - MUST be the last element defined when using a array destructuring
*/
